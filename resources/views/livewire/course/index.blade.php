...
new class extends Component {
    ...
    public function with(): array
    {
        return [
            ...
            'cForUser' => Course::Where('status', 1)->get(),
        ];
    }
    ...
    /**
     * Add a new course. Validate and sanitize the input data.
     * Generate a unique image name and resize the image.
     * Create a new course record in the database with the data.
    ...
    /**
     * Get the details for a course by ID.
     * Assign to courseDetail property to display in UI.
     */
    ...
    /**
     * Populate the edit form fields with a course's data.
     * Find the course by ID and assign its data to component properties.
     */
     ...
     * Validate input data.
     * Check for updated image and handle saving new image if provided.
                    ...
                    <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
                        <div class="card" style="width: 22rem;">
                            ...
                            <div class="card-body">
                                ...
                                <h6 style="font-size: 14px" class="my-2">{{ $course->name }}</h6>
                                <div class="d-flex justify-content-between font-bold">
                                    <p>Discount Fee : &#2547;{{ $course->discount_price }}</p>
                                    <p>Regular Fee : &#2547;<del style="color: red">{{ $course->regular_price }}</del></p>
                                </div>
                                <div class="d-flex justify-content-end">
                                    <a wire:click='purchase({{ $course->id }})' href="{{ route('purchase.index') }}" class="btn btn-pill btn-outline-primary btn-sm">Purchase</a>
                                </div>
                            </div>
                        </div>
                    </div>
